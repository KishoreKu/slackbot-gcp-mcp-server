...
This log is the training dataset for Phase 2 model fine-tuning
and the source of truth for the ops dashboard.
...
SCHEMA = [
    ...
    # Feedback columns — populated by ops team later
...
class BigQueryClient:
    ...
    async def log_transaction(
        ...
        """Stream a single row to BigQuery. Non-blocking on the hot path."""
        row = {
            ...
            "signals_json":      json.dumps([s.dict() for s in result.signals]),
