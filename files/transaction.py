    ...
    def validate_geo_consistency(self) -> "TransactionRequest":
        ...
        if self.card and self.device:
            ...
            if cc and gc and cc != gc:
                # Store mismatch flag for the signal engine
...
class TriggeredSignal(BaseModel):
    ...
    score_delta: float = Field(..., description="How much this signal contributed (0–1)")
...
class ScoringResponse(BaseModel):
    ...
    explanation: str      = Field(..., description="Plain-English explanation for fraud ops teams")
