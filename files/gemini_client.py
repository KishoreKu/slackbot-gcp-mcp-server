...
class GeminiClient:
    ...
    async def explain(
        ...
        """Generate a plain-English explanation for the scoring decision."""
        ...
        prompt = self._build_prompt(tx, triggered_signals, risk_score, decision, baseline)
    ...
    def _build_prompt(
        ...
        """Structured prompt with all context the model needs."""
